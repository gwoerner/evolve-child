...
<div id="primary" class="<?php evolve_layout_class($type = 1); ?>">
    ...
    if (is_date()) {
        ...
        <h2 class="page-title archive-title"> <!--<?php _e('Posts in category', 'evolve'); ?>--> <span id="category-title"> <?php single_cat_title(); ?></span></h2> <!-- afficher uniquement le titre de la catégorie -->
